 ...
 *                MinGW32 _strdup functions.  These are each too small
 ...
 *
 * Description :  _strdup wrapper that either succeeds or causes
 *                program termination.
 *
 *                Useful in situations were the string length is
 *                "small" and _strdup() failures couldn't be handled
 *                better anyway. In case of debug builds, failures
 *                trigger an assert().
 *
 * Parameters  :
 ...
 *
 * Returns     :  Pointer to newly _strdup'd copy of the string.
 *
 *********************************************************************/
 ...
 *
 *                char * s = _strdup(...); // don't check for error
